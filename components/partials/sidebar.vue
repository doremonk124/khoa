        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-user-material">
                <div class="sidebar-user-material-body">
                    ...
                    <div class="sidebar-user-material-footer">
                        <a href="#user-nav" class="d-flex justify-content-between align-items-center text-shadow-dark dropdown-toggle" data-toggle="collapse" aria-expanded="false"><span>Tài khoản</span></a>
                    </div>
                </div>
            ...
            <div class="card card-sidebar-mobile">
                <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item nav-item-submenu">
                        <a href="#" class="nav-link"><i class="icon-copy"></i> <span>Bố cục</span></a>
                    ...
                    <li class="nav-item nav-item-submenu">
                        <a href="#" class="nav-link"><i class="icon-color-sampler"></i> <span>Giao diện</span></a>
