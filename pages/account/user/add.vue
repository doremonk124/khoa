<template>
    <div>
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                ...
                <div class="header-elements d-none text-center text-md-left mb-3 mb-md-0">
                    <div class="btn-group">
                        <button type="button" @click="onSave()" class="btn btn-sm bg-indigo-400"><i class="icon-database-insert mr-1"></i> Cập nhật</button>
        ...
        <div class="content">
            <div class="card">
                <form id="form-data" action="<%= route_page %>/add" method="post">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <fieldset class="mb-2">
                                    <legend class="font-weight-semibold">
                                        <i class="icon-file-text mr-2"></i> Thông tin chung
