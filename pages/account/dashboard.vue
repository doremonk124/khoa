                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="mr-3">
                                                <a href="#">
                                                    <img src="/global_assets/images/brands/bing.png" class="rounded-circle"
                                                         width="32" height="32"
                                                         alt="">
                                                </a>
                                            </div>
                                    ...
                                    <td><span class="text-danger"><i class="icon-stats-decline2 mr-2"></i> - 5.78%</span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="mr-3">
                                                <a href="#">
                                                    <img src="/global_assets/images/brands/amazon.png" class="rounded-circle"
                                                         width="32" height="32"
                                                         alt="">
                                                </a>
                                            </div>
                                    ...
                                    <td><span class="text-success-600"><i class="icon-stats-growth2 mr-2"></i> 6.79%</span>
                                    </td>
                                            ...
                                            <div class="list-icons-item dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a href="#" class="dropdown-item"><i class="icon-history"></i> Full
                                                        history</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a href="#" class="dropdown-item"><i class="icon-plus3 text-blue"></i>
                                                        Unresolve issue</a>
                                                    <a href="#" class="dropdown-item"><i
                                                        class="icon-cross2 text-danger"></i> Close issue</a>
                                                </div>
